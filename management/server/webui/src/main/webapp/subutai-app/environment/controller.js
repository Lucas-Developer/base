...
function EnvironmentViewCtrl($scope, $rootScope, environmentService, trackerSrv, identitySrv, SweetAlert, $resource, $compile, ngDialog, $timeout, $sce, $stateParams, DTOptionsBuilder, DTColumnDefBuilder, $state, $location) {
    ...
    function editEnvironment(environment) {
        vm.currentEnvironment = environment
        console.log(vm.environmentSimpleViewCtrl)
        vm.environmentSimpleViewCtrl.editEnvironment(vm.currentEnvironment)
