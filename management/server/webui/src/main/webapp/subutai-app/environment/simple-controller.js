...
EnvironmentSimpleViewCtrl.$inject = ['$scope', '$rootScope', '$stateParams', '$location', 'environmentService', 'trackerSrv', 'SweetAlert', 'ngDialog', '$timeout', 'identitySrv'];

function EnvironmentSimpleViewCtrl($scope, $rootScope, $stateParams, $location, environmentService, trackerSrv, SweetAlert, ngDialog, $timeout, identitySrv) {

    console.log('EnvironmentSimpleViewCtrl started: ', $stateParams.environmentId)
    ...
    function loadEnvironment(environmentId) {
        if (environmentId !== '') {
            ...
            console.log('Environment id not set.')
        ...
        for (var container in environment.containers) {
            ...
            var devElement = new joint.shapes.tm.devElement({
                ...
                attrs: {
                    ...
                    title: {
                        text: environment.containers[container].hostname + " ("
